    ...
    Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs) Handles dgw.MouseClick
        Try
            If dgw.Rows.Count > 0 Then
                ...
                If lblSet.Text = "Service Billing" Then
                    frmBilling1.Show()
                    Me.Hide()
                    ...
                    frmBilling1.txtTotalPayment.Text = dr.Cells(10).Value.ToString()
                    'frmSendSMS.txtCustomerID.Text = dr.Cells(4).Value.ToString()
                    'frmSendSMS.txtCustomerName.Text = dr.Cells(5).Value.ToString()
                    ...
                    'frmServices.txtCustomerID.Text = dr.Cells(5).Value.ToString()
                    'frmServices.txtCID.Text = dr.Cells(3).Value.ToString()
                    'frmServices.txtCustomerName.Text = dr.Cells(6).Value.ToString()
