...
Public Class rptInvoice1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sales_and_Inventory_System.rptInvoice1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInvoice1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInvoice1 = New rptInvoice1()
        rpt.Site = Me.Site
        Return rpt
    End Function
