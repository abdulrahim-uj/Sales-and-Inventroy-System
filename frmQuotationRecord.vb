    ...
    Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs) Handles dgw.MouseClick
        Try
            If dgw.Rows.Count > 0 Then
                ...
                frmQuotation.btnSaveNew.Enabled = False
                frmQuotation.btnUpdateNew.Enabled = True
                frmQuotation.btnPrintNew.Enabled = True
                frmQuotation.btnDeleteNew.Enabled = True
                con = New SqlConnection(cs)
                con.Open()
