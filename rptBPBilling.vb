...
Public Class rptBPBilling
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sales_and_Inventory_System.rptBPBilling.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBPBilling
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBPBilling = New rptBPBilling()
        rpt.Site = Me.Site
        Return rpt
    End Function
